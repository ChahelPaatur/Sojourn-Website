          ...
          <div className="text-center">
            ...
            >
              <DesktopMotion
                ...
                whileTap={{ scale: 0.95 }}
              >
                <a href="/countdown" className="flex items-center justify-center space-x-2 text-black">
                  ...
                  >
                    <a href="/countdown" className="flex items-center space-x-3">
                      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <path d="M14 17h-3c-.55 0-1-.45-1-1s.45-1 1-1h3c.55 0 1 .45 1 1s-.45 1-1 1zm3-3H7c-.55 0-1-.45-1-1s.45-1 1-1h10c.55 0 1 .45 1 1s-.45 1-1 1zm0-4H7c-.55 0-1-.45-1-1s.45-1 1-1h10c.55 0 1 .45 1 1s-.45 1-1 1z"/>
                      </svg>
                      <span>Book Now</span>
                    </a>
                  </DesktopMotion>
            ...
            >
              <div className="max-w-xl">
                ...
                <DesktopMotion
                  ...
                  className="px-8 py-4 bg-gradient-to-r from-[#ff7e54] to-[#cf4b6c] text-white rounded-full font-semibold text-lg"
                >
                  <a href="/countdown">Start Exploring</a>
                </DesktopMotion>
              </div>
            </DesktopMotion>
